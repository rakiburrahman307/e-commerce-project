                ...
                <form className="w-full md:w-1/2" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="mb-6 relative">
                        ...
                        <p className="absolute right-4 top-[55%]">
                            {
                                show ? <FaEye className={`text-secondary-text dark:text-secondary-text-dark`} onClick={() => setShow(!show)} size={20} /> : <FaEyeSlash className={`text-secondary-text dark:text-secondary-text-dark`} onClick={() => setShow(!show)} size={20} />
                            }
                        </p>
                    </div>
