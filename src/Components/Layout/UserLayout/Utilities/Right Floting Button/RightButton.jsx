                ...
                isOpenDrawer ? (<div className=" top-[35%] right-0 fixed z-10">
                    {
                        utilityButton?.map(({ id, child }) =>
                            <li
                                ...
                                key={id}
                                className={`flex justify-between items-center w-36 h-14 px-4 mr-[-90px] duration-300 ${selectedColor} hover:mr-[-10px] cursor-pointer rounded-tl-2xl rounded-bl-2xl dark:bg-semi-dark dark:text-secondary-text-dark`}>
                                <p
                    ...
                    <div className={`fixed top-[35%] ${isOpenDrawer ? 'translate-x-[9000px]' : 'translate-x-[300px] right-[280px]'} z-10 transition-all duration-500`}>
                        <div className={`menu p-4 w-80 min-h-full px-4 ${selectedColor} cursor-pointer rounded-tl-2xl rounded-bl-2xl dark:bg-semi-dark dark:text-secondary-text-dark`}>
                            <div>
